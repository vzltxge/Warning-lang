...
class TypeChecker:
  def __init__(self) -> None:
    ...
    self.__type_map: dict[Any, dict[str, Any]] = {
      ...
      ctypes.c_short: {"rank": lowest_rank + 3, "ctype": ctypes.c_int16},
      ctypes.c_long: {"rank": lowest_rank + 4, "ctype": ctypes.c_int32},
      ctypes.c_longlong: {"rank": lowest_rank + 5, "ctype": ctypes.c_int64},
      ctypes.c_float: {"rank": lowest_rank + 6, "ctype": ctypes.c_double},
      ctypes.c_double: {
        "rank": lowest_rank + 7,
  ...
  def is_size_of_value_valid(self, type_, value, object) -> bool:
    ...
    FLOAT_RANGES = {
      ctypes.c_float: (1.1754943508222875e-38, 3.4028234663852886e38),
      ctypes.c_double: (2.2250738585072014e-308, 1.7976931348623157e308),
    }
